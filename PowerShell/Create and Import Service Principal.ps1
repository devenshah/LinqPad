...
<# https://blogs.technet.microsoft.com/keithmayer/2016/03/26/8-steps-for-using-azure-ad-service-principal-certificate-authentication-with-azure-automation-powershell-workflow-runbooks/  #>

<#-----------------------------------------------------------------#>
Write-ToHost "Step 1: Create certificate for Azure AD Service Principal" 15
...
<#-----------------------------------------------------------------#>
Write-ToHost "Step 2: Export Certificate to PFX file " 15

$pfxPassword = #"Wh0L3tTh3D0g50ut"
    Read-Host `
    -Prompt "Enter password to protect exported certificate:" `
    -AsSecureString

$pfxFilepath = #"d:\temp\FuncstionPocAppCert.pfx"
    Read-Host `
...
<#-----------------------------------------------------------------#>
Write-ToHost "Step 3: Create Key Credential Object " 15
...
<#-----------------------------------------------------------------#>
Write-ToHost "Step 4: Create Azure AD Service Principal" 15
...
<#-----------------------------------------------------------------#>
Write-ToHost "Step 5: Assign Role-Based Access Control (RBAC) Permissions to the Service Principal" 15
...
<#-----------------------------------------------------------------#>
Write-ToHost "Step 6: Test authenticating as Service Principal" 15
...
<#-----------------------------------------------------------------#>
Write-ToHost "Step 7: Define Azure Automation Assets" 15
# Select existing Azure Automation account

$automationAccount =
    Get-AzureRmAutomationAccount | Out-GridView `
...
<#-----------------------------------------------------------------
Write-ToHost "Step 8: Build Sample Azure Automation PowerShell Workflow Runbook" 15
